...
function GroupRightSidebar({
  ...
  return (
    <>
      <aside className="hidden lg:block lg:sticky lg:top-[60px] lg:shrink-0 lg:overflow-y-auto h-[calc(100vh-60px)] w-60 px-4 py-5 border-l border-white/5">
        <div className="mb-8">
          <SectionHeader
            title="Campus Events"
            action="View all →"
