...
function ProfilePage() {
  ...
  const handleMessage = () => {
    ...
    if (existingThread) {
      ...
      const conversation: Message = {
        ...
        participant: {
          id: draft.id,
          firstname: draft.firstname || (draft as any).name || "",
          lastname: draft.lastname || "",
          avatar: draft.avatar,
          isOnline: false,
          isVerified: draft.isVerified,
          program: draft.program || (draft as any).organizationType || "",
          accountType: isOrg ? "organization" : "student",
        },
        messages: [],
        lastMessage: "",
        lastTime: "",
  ...
  const getDisplayInfo = () => {
    if (isOrg) {
      return (draft as any).organizationType;
    }
